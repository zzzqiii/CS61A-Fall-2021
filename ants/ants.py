...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not start.is_hive:
            if start.bees and self.min_range <= distance <= self.max_range:
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        #     return
        # return cls()
        #gamestate.ant_types["Queen"] = QueenAnt
        #print("Queen" not in gamestate.ant_types.keys())
        #print(gamestate.ant_types.keys())
    ...
    def action(self, gamestate):
        ...
        while place:
            if place.ant:
                if place.ant.damage and not place.ant.buffed:
                    place.ant.buff()
                if place.ant.is_container and place.ant.ant_contained and not place.ant.ant_contained.buffed:
