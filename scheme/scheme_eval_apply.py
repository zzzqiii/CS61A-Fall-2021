...
def optimize_tail_calls(original_scheme_eval):
    ...
    def optimized_eval(expr, env, tail=False):
        ...
        # BEGIN PROBLEM EC
        "*** YOUR CODE HERE ***"
        #if tail and scheme_symbolp(expr):
        #if isinstance(original_scheme_eval, Unevaluated):
